...
# print CollectTemperature(batterysample)
...
# class CreateAttributeList(unittest.TestCase):

# 	def testOne(self):
# 		self.assertEqual(CreateAttributeList(samplelines), 'temperature;276')
